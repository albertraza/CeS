...
{
    public partial class frmFacturaSemanalAtradados : Form
    {
        public frmFacturaSemanalAtradados()
        {
            InitializeComponent();
        }
        ...
        private void frmFacturaSemanalAtradados_Load(object sender, EventArgs e)
        {
